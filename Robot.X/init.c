...
void init(void){
    ...
    /// LED Vie: Output pour indiquer l'état de la batterie
    TRISBbits.RB5 = 0;

    /** TIMER0
     * 
     * Actualise l'état de la batterie, calcule le sonar et fait décélérer.
     * 
    ...
    /// Serial: Async mode
    TXSTAbits.SYNC = 0;
    /// Serial: Voir documentation pour réglage conseillé page 207, edition 2008
    SPBRG = 51;  // 9.615 kHz
